                        ...
                        <div class="form-group col-6">
                            ...
                            <select name="categories[]" autocomplete="off" id="categories" class="select2 w-100"
                                ...
                                @foreach($categories ??[] as $category)
                                    <option
                                        {{ in_array($category->id, (old('$category'))??$categories_select??[]  ) ? 'selected' : '' }} value="{{$category->id}}">{{$category->Name}} </option>
                        ...
                        <div class="col-6 " style="margin-top: 28px;">
                            <div class="form-group ">
                                ...
                                <input type="number" min="1" max="100" name="discount"
                                       value="{{old('discount')??$entity->Value}}"
                    ...
                    <div class="row mt-4">
                        <div class=" col-6 ">
                            ...
                            <x-flatpickr value="{{old('beginning_of_reservation')??$entity->BeginDate}}"
                                         name="beginning_of_reservation"
                                         show-time time-format="h:i"/>
                        </div>
                        <div class="col-6">
                            <label for="end_of_reservation">@langucw('end of reservation')</label>
                            <x-flatpickr value="{{old('end_of_reservation')??$entity->EndDate}}"
                                         name="end_of_reservation" show-time
                                         time-format="h:i"/>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class=" col-6 ">
                            ...
                            <x-flatpickr value="{{old('beginning_of_receipt')??$entity->BeginDelivery}}"
                                         name="beginning_of_receipt" show-time
                                         time-format="h:i"/>
                        </div>
                        <div class="col-6">
