...
return [
    ...
    */
    ...
    'facebook' => [
        ...
        'redirect' => env('FACEBOOK_REDIRECT'), //must use https, if relative path given, will automatically converted to absolute url
    ],
    'instagram' => [
    ...
    'google' => [
        'client_id' => env('GOOGLE_CLIENT_ID'),         // Your fb Client ID
        'client_secret' => env('GOOGLE_CLIENT_SECRET'), // Your fb Client Secret
        'redirect' => env('GOOGLE_REDIRECT'), //must use https, if relative path given, will automatically converted to absolute url
    ],
